...
class GetSaldoAtualUseCase @Inject constructor(
    ...
    operator fun invoke(ate: Long): Flow<Double> =
        combine(
            ...
            val saldoMovimentosAteReferencia = transacoes
            ...
            val dividaCartoes = calcularDividaComprasAvulsasAte(transacoes, cartoes, ate)
            ...
            (saldoContas ?: 0.0) + saldoMovimentosAteReferencia - dividaCartoes - dividaParcelamentos
        }
    ...
    private fun calcularDividaComprasAvulsasAte(
        ...
        val pagamentos = transacoes
            .filter(RegrasFinanceiras::isPagamentoFatura)
            .filter { it.dataCompetencia <= ate }
